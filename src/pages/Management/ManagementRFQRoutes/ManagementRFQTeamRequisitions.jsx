...
const ManagementRFQTeamRequisitions = () => {
    ...
    return(
        <>
            <ManagementRFQTeamRequisitionsStyled>
                <MainHeader
                ...
                <div className="body page-container">
                    ...
                    <ManagementSubDashboardNav myRequisitions teamRequisitions teamRequisitionsActive otherRequistions/>
                    <TeamRequisitionsStyled>
...
const ManagementRFQTeamRequisitionsStyled = styled.div``;

const TeamRequisitionsStyled = styled.div`
    display: flex;
...
export default ManagementRFQTeamRequisitions;