...
const ManagementRFQOtherRequisitions = () => {
    ...
    return(
        <>
            <ManagementRFQOtherRequisitionsStyled>
                <MainHeader
                ...
                <div className="body page-container">
                    ...
                    <ManagementSubDashboardNav myRequisitions teamRequisitions otherRequistions otherRequistionsActive/>
                    <AdminUsersStyled>
...
const ManagementRFQOtherRequisitionsStyled = styled.div``;
...
export default ManagementRFQOtherRequisitions;