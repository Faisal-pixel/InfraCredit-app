...
import ManagementSubDashboardNav from "../ManagementNavigations/ManagementSubDashboardNav";
...
const ManagementRFQMyRequisitions = () => {
    ...
    return(
        <>
            <ManagementRFQMyRequisitionsStyled>
                <MainHeader
                ...
                <div className="body page-container">
                    <UserGreetings />
                    <ManagementDashboardNavigationComponent requestForQuotesActive/>
                    <ManagementSubDashboardNav myRequisitions myRequisitionsActive teamRequisitions otherRequistions shouldIncludeButton buttonName="Create New RFQ"/>
                    <MyRequisitionsStyled>
...
const ManagementRFQMyRequisitionsStyled = styled.div``;

const MyRequisitionsStyled = styled.div`
    display: flex;
...
export default ManagementRFQMyRequisitions;