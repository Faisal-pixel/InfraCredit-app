...
const ProcurementAdminRFQOtherRequisitionDetails = () => {
    ...
    return <>
        <MainHeader
            ...
            />
        <ProcurementAdminRFQOtherRequisitionDetailsStyled className="page-container body">
            
                <BreadCrumbsNavigation dashboardGoTo="/procurement-admin">
                    <BreadCrumbsFrameIcon />
                    <BreadCrumbsNextName breadCrumbsNextName="Other Requisitions"/>
                    <BreadCrumbsFrameIcon />
        ...
        </ProcurementAdminRFQOtherRequisitionDetailsStyled>
...
const ProcurementAdminRFQOtherRequisitionDetailsStyled = styled.div`
    display: flex;
...
export default ProcurementAdminRFQOtherRequisitionDetails;