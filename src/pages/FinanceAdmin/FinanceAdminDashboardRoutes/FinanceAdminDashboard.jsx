        ...
        <>
            <FinanceAdminDashboardStyled>
                ...
                <div className="body page-container">
                    ...
                    <FinanceAdminDashboardNavigationComponent dashboardActive/>
                    <ActivityStatus activityStatusData={activityStatusDataState} />
                    <RequisitionListContainer requisitionContainerName="My Requisitions" goTo="/finance-admin/dashboard/requisitions/details" listData={myRecentRequisitionsData}/>
                </div>
            </FinanceAdminDashboardStyled>
...
const FinanceAdminDashboardStyled = styled.div``;
