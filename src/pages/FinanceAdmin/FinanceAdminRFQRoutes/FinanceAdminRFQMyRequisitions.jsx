...
const FinanceAdminRFQMyRequisitions = () => {
    ...
    return(
        <>
            <FinanceAdminRFQMyRequisitionsStyled>
                <MainHeader
                ...
                <div className="body page-container">
                    ...
                    <FinanceAdminSubDashboardNav myRequisitions myRequisitionsActive teamRequisitions otherRequistions shouldIncludeButton buttonName="Create New RFQ"/>
                    <AdminUsersStyled>
...
const FinanceAdminRFQMyRequisitionsStyled = styled.div``;
...
export default FinanceAdminRFQMyRequisitions;