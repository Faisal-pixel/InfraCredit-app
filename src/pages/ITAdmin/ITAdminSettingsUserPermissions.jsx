...
const ITAdminSettingsUserPermissions = () => {
    ...
    return(
        <>
            <ITAdminSettingsUserPermissionsStyled>
                <MainHeader
                ...
                <div className="body page-container">
                        ...
                        <ITAdminSubDashboardNav adminUser userRoles userPermissions userPermissionsActive/>
                        <InputParentStyled>
                            <div className="input">
...
const ITAdminSettingsUserPermissionsStyled = styled.div``;
