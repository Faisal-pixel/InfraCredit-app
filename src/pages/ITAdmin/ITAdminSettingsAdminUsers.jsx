...
const ITAdminSettingsAdminUsers = () => {
    ...
    return(
        <>
            <ITAdminSettingsAdminUsersStyled>
                <MainHeader
                ...
                <div className="body page-container">
                        ...
                        <ITAdminSubDashboardNav adminUser adminUserActive userRoles userPermissions shouldIncludeButton buttonName="Add new user"/>
                    <AdminUsersStyled>
...
const ITAdminSettingsAdminUsersStyled = styled.div``;
