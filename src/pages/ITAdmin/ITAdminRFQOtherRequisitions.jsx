...
const ITAdminRFQOtherRequisitions = () => {
    ...
    return(
        <>
            <ITAdminRFQOtherRequisitionsStyled>
                <MainHeader
                ...
                <div className="body page-container">
                    ...
                    <ITAdminSubDashboardNav myRequisitions teamRequisitions otherRequistions otherRequistionsActive/>
                    <AdminUsersStyled>
                        <RequisitionListContainer requisitionContainerName="Other Requisitions" listData={myRecentRequisitionsData} goTo="/it-admin/request-for-quotes/other-requisitions/details" shouldIncludeSearchFilter/>
                    </AdminUsersStyled>
                </div>
            </ITAdminRFQOtherRequisitionsStyled>
...
const ITAdminRFQOtherRequisitionsStyled = styled.div``;
...
export default ITAdminRFQOtherRequisitions;