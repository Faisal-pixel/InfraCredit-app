...
const ITAdminRequisitionDetails = () => {
    ...
    return <>
        <MainHeader
            ...
            />
        <ITAdminRequisitionDetailsStyled className="page-container body">
            
                <BreadCrumbsNavigation dashboardGoTo="/it-admin">
        ...
        </ITAdminRequisitionDetailsStyled>
...
const ITAdminRequisitionDetailsStyled = styled.div`
    display: flex;
...
export default ITAdminRequisitionDetails;