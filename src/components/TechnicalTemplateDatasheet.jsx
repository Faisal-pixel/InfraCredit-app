...
const TechnicalTemplateDatasheet = () => {
    return <>
        <TechnicalTemplateDatasheetStyled>
        <div className="technical-template-top">
                        ...
                        <div className="technical-template-middle">
                        ...
                        <div className="technical-template-bottom">
...
const TechnicalTemplateDatasheetStyled = styled.div`
...
export default TechnicalTemplateDatasheet;
