...
const EsgTemplateDatasheet = () => {
    return <>
        <EsgTemplateDatasheetStyled>
        <div className="esg-template-top">
                        ...
                        <div className="esg-template-middle">
                        ...
                        <div className="esg-template-bottom">
...
const EsgTemplateDatasheetStyled = styled.div`
...
export default EsgTemplateDatasheet;
